                        ...
                        <div class="col-lg-3 col-md-4">
                            <div class="myaccount-tab-menu nav" role="tablist">
                                <a href="#dashboad" class="" data-toggle="tab"><i class="fa fa-dashboard"></i>
                                    Dashboard</a>
                                <a href="#orders" data-toggle="tab" class=""><i class="fa fa-cart-arrow-down"></i>
                                    Orders</a>
                                <a href="#address-edit" data-toggle="tab" class="active"><i
                                    ...
                                    <div class="myaccount-content">
                                        ...
                                        <div class="account-details-form">
                                            <form action="#">
                                                ...
                                                <div class="single-input-item">
                                                    <label for="display-name" class="required">Numero de la carte
                                                        bancaire</label>
